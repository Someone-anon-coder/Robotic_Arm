...
def main():
    ...
    """
    # --- Setup ---
    client = p.connect(p.GUI) # Use GUI for interactive testing
    ...
    # --- Main Loop ---
    print("Starting simulation. Move sliders to control the glove.")
    try:
        while True:
            # Update joints based on slider values
            ...
            # Step the simulation to apply forces and update positions
            p.stepSimulation()
            ...
            # --- Console Output ---
            # Clear console for clean, real-time display
            # (Note: os.system('clear') works on Unix-like systems)
